    ...
    <div v-if="canManageTwoFactor" class="space-y-6">
        ...
        >
            <p class="text-sm text-muted-foreground">
                Quando você ativa a autenticação de dois fatores, será
                solicitado um PIN seguro durante o login. Este PIN pode ser
                obtido em um aplicativo compatível com TOTP no seu celular.
            </p>
        ...
        <div v-else class="flex flex-col items-start justify-start space-y-4">
            <p class="text-sm text-muted-foreground">
                Será solicitado um PIN seguro e aleatório durante o login, que
                você pode obter no aplicativo compatível com TOTP no seu
                celular.
            </p>
